import { BtcPredGameParams, BtcPredResponse, BtcPredSide } from "@/server/models/custom/games";
...
export async function runBtcPredGame(params: BtcPredGameParams): Promise<BtcPredResponse> {
